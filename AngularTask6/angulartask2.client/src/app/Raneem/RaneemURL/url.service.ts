...
export class URLService {
  ...
  AddServes11(data: any): Observable<any> {
    return this.http.post<any>(`${this.staticData}/Services/addservise`, data)
  }
  UpdateService(id: any, data: any): Observable<any> {
    return this.http.put(`https://localhost:7130/api/Services/UpdateServicesDetails/${id}`, data)
  }
