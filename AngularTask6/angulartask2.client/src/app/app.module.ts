...
import { UpdateservicComponent } from './Raneem/Admin/updateservic/updateservic.component';
import { GetServicesAdminComponent } from './Raneem/Admin/get-services-admin/get-services-admin.component';
      ...
      [
        ...
        { path: "Login", component: LoginComponent },
        {
          path: "Dashbord", component: DashbordComponent, children: [
            ...
            { path: "UpdateServices/:id", component: UpdateservicComponent },
            { path: "GetServices", component: GetServicesAdminComponent }
        ] }
